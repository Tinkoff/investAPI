...
2. **Ticker** — краткое (1-5 букв) наименование ценной бумаге *на конкретной бирже*. Без 
...
**Основным идентификаторов торгового инструмента при работе с TINKOFF INVEST API 
является *FIGI*.**