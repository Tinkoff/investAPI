...
Для отображения информации о возможности торговли инструментам по выходным добавлен флаг 

###Какие заявки по опционам возможно выставить?

Торговля опционами на данный момент доступна только лимитными заявками. 