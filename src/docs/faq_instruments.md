####[1. Что такое Figi инструмента?](#1.1)

####[2. Как мне найти Figi инструмента по его названию, тикеру или isin?](#1.2)

####[3. Что такое class_code и где его найти?](#1.3)

####[4. Как понять, что бумага доступна для торговли через TINKOFF INVEST API?](#1.4)

####[5. Что такое накопленный купонный доход облигации и как его узнать?](#1.5)

####[6. Как узнать стоимость шага цены(min_price_increment_amount) фьючерса?](#1.6)

####[7. Как узнать на какой бирже исполняются расчеты по инструменту?](#1.7)

####[8. Как найти базовый актив фьючерса?](#1.8)

####[9. Как отличить инструмент доступный для ИИС?](#1.9)

####[10. Как получить информацию об брендах?](#1.10)

####[11. Как по позиции найти инструмент?](#1.11)

####[12. Ставки риска и их коэфффиценты](#1.12)

####[13. Как узнать торгуется ли инструмент на выходных?](#1.13)

####[14. Какие заявки по опционам возможно выставить?](#1.14)
