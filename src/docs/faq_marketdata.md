####[1. Что такое шаг цены?](#2.1)
####[2. Отличие лотов и количества инструментов](#2.2)
####[3. Цены облигаций и фьючерсов](#2.3)
####[4. Формулы расчета реальной стоимости инструментов в валюте ](#2.4)
####[5. Какие интервалы доступны при запросе исторических свечей?](#2.5)
####[6. Как одним запросом получить последние цены по нескольким инструментам?](#2.6)
####[7. Как подписаться на разные типы данных в рамках stream-соединения сервиса котировок?](#2.7)
####[8. Внебиржевые инструменты в TINKOFF INVEST API](#2.8)
####[9. Какие данные отливаются в стриминг стаканов?](#2.9)
####[10. Торговля бумагами Тинькофф через TINKOFF INVEST API](#2.10)
####[11. Валюты в TINKOFF INVEST API](#2.11)
####[12. Почему отличаются исторические цены в TINKOFF INVEST API и других источниках?](#2.12)
####[13. Как получить исторические рыночные данные?](#2.13)
####[14. Какое максимальное количество запросов на подписку в MarketDataStream?](#2.14)
####[15. Как узнать дату, с которой можно получить свечи по инструменту?](#2.15)
####[16.Как узнать доступности торгов инструментом через API?](#2.16)
###[17.Какой идентификатор инструмента использовать для получения данных в сервисе котировок?](#2.17)
