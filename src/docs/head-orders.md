...
**Важно!** В целях сохранения единообразия **в запросах** методов [postOrder](/investAPI/orders#postorder) параметр *order_id* - ключ идемпотентности, передаваемый от клиента. 
