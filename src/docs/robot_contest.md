...
В таблице мы собрали **поддерживаемые** конкурсные работы, на которые вы сможете ориентироваться при разработке собственного торгового робота. Ознакомиться со всеми конкурсными работами вы можете [здесь](https://github.com/Tinkoff/invest-robot-contest/blob/main/table-result.md).
...
| https://github.com/EIDiamond/invest-bot | Робот на python для интрадей торговли на Московской бирже с возможность информирования о сделках и результатах торговли в Telegram чат. | Python |
